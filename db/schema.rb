...
ActiveRecord::Schema[7.1].define(version: 2024_03_04_171724) do
  create_table "new_user_offers", force: :cascade do |t|
    t.integer "amount"
  ...
  add_foreign_key "transactions", "users", column: "to_account_id"
end
